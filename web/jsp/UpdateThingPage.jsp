				...
				<center><table cellpadding="3">
					<tr>
					  <td align="center">
							...
							<br />
                                                        <div>
        <form id="UpdateThing"  action="/Auction/Controller" method="post" >
        <div>
        <input type="hidden" name="action" value="updatething">
        
        <center> <strong>Текущий номер лота: </strong><br>
        
        <input id="curserial" name="curserial"  type="text" value="" maxlength="25" size="25" required><br>
